...
gaming_aspect_cate_list = [
    'general review', 'performance - stability', 'cost',
    'graphic - ui', 'character', 'community', 'branding', 'gameplay',
    'audio', 'content - storyline'
]
...
cate_list = {
    ...
    "gaming": gaming_aspect_cate_list
}
...
force_words = {
    ...
    'asqp': {
        "rest15": rest_aspect_cate_list + list(sentword2opinion.values()) + ['[SSEP]'],
        "rest16": rest_aspect_cate_list + list(sentword2opinion.values()) + ['[SSEP]'],
        'gaming': gaming_aspect_cate_list + list(sentword2opinion.values()) + ['[SSEP]']
    }
}
